...
import WebBuilderIcon from "@/components/WebBuilderIcon";
import WebBuilderLogo from "@/components/WebBuilderLogo";
            ...
            <div className="max-w-[900px] mx-auto w-full flex justify-between items-center">
              <div className="flex gap-24 items-center">
                <Link href="/" className="flex items-center gap-2">
                  <WebBuilderIcon className="w-7 h-7 text-accent-black" />
                  <WebBuilderLogo />
                </Link>
              </div>
            </div>
